...
void	Checkbox::_setText(std::string title) {
...
void	Checkbox::setPosSize(t_pos pos, t_size size) {
	_cell_origin = pos;
...
void	Checkbox::setValue(SDL_FPoint mouse) {
